...
## High-Fidelity Simulation Model for the Posterior Sagittal Anorectoplasty in Anorectal Malformations with Rectovestibular and Rectourethral Fistula.

- 来源: JPS 圣刊 · 推送 05:39
- 期刊: J Pediatr Surg · 中科院医学2区(儿科1区/外科2区) · IF 2.3 · JCR Q2
- 国家/单位: Tuebingen · University Children's Hospital Tuebingen
- 通讯作者: Jhala T (tobias.jhala@med.uni-tuebingen.de)
- DOI: 10.1016/j.jpedsurg.2026.163370
- 获取全文: [DOI 全文](https://doi.org/10.1016/j.jpedsurg.2026.163370) · [PubMed](https://pubmed.ncbi.nlm.nih.gov/42562191/)

**中文总结**：- 研究目的：开发一种高仿真、低成本的动物组织模型，用于肛门直肠畸形伴直肠前庭瘘和直肠尿道瘘的后矢状入路肛门直肠成形术（PSARP）手术训练。
- 核心发现/数据：模型利用家禽屠宰副产品（鸡会阴结构结合火鸡食管段）重建多层组织结构和瘘管，可模拟国际共识手术框架中的关键11个解剖分离步骤；但无法模拟患者体位、术前泌尿生殖内镜及括约肌刺激步骤。该模型成本低廉且可重复制作。
- 临床启示：该模型为儿科结直肠外科提供了高仿真PSARP训练平台，有助于结构化手术培训和能力评估，弥补因疾病罕见导致的实操训练不足。

**原文摘要**：Surgical training for posterior sagittal anorectoplasty (PSARP) in anorectal malformations is limited by the rarity of the condition and restricted operative exposure. Existing low-cost simulators facilitate learning of procedural steps but lack realistic tissue characteristics and anatomical fidelity. A high-fidelity animal-tissue simulation model was developed using poultry slaughter by-products. The model combines the perineal anatomy of a chicken with a segment of turkey esophagus to recreate multilayer tissue structures and simulate rectovestibular and rectourethral fistulae. Model construction and surgical simulation were designed to reflect the standardized operative steps for PSARP defined by international consensus. The model reproduces layered anatomy, tissue adhesions, and haptic properties relevant to the PSARP dissection. Surgical simulation enables trainees to perform the key 11 surgical dissection steps of the consensus operative framework. Steps related to patient positioning, preoperative genitourinary endoscopy, and sphincter stimulation cannot be simulated. The model is inexpensive and reproducible. A poultry cadaver model provides a high-fidelity platform for simulation of PSARP in anorectal malformations with rectovestibular and rectourethral fistula. It may support structured surgical training and competency development in pediatric colorectal surgery.

---

## Assessing the Burden of Adolescent Care in Paediatric Surgery in a Single Tertiary Institution in the Caribbean: An Age-Stratified Case-Mix Audit.

- 来源: JPS 圣刊 · 推送 05:39
- 期刊: J Pediatr Surg · 中科院医学2区(儿科1区/外科2区) · IF 2.3 · JCR Q2
- 国家/单位: Mount Hope · Eric Williams Medical Sciences Complex
- 通讯作者: Seecharan A (arvind.seecharan@my.uwi.edu)
- DOI: 10.1016/j.jpedsurg.2026.163364
- 获取全文: [DOI 全文](https://doi.org/10.1016/j.jpedsurg.2026.163364) · [PubMed](https://pubmed.ncbi.nlm.nih.gov/42562189/)

**中文总结**：- 研究目的：量化特立尼达和多巴哥一家三级儿科外科中心中青少年患者的手术负担，并分析不同年龄层先天/发育性与获得性疾病分布的差异。
- 核心发现/数据：在964例转诊/入院记录、379例手术和661例新门诊中，青少年分别占23.7%、17.4%和11.5%，并贡献了25.7%的急诊转诊和28.7%的急诊手术。青少年手术中72.7%为获得性疾病，而新生儿中仅13.3%；先天/发育性疾病比例从新生儿的80.0%降至青少年的24.2%。阴囊探查、阑尾切除术和软组织脓肿引流占青少年急诊手术的97.0%。
- 临床启示：青少年患者带来以获得性疾病为主的显著急诊工作量，提示应针对特定诊断建立与成人外科共享的诊疗路径，同时将儿科资源集中用于新生儿、先天性疾病、肿瘤及重建手术。

**原文摘要**：Paediatric surgical services are defined by age-specific physiology, pathology and care requirements, yet adolescents frequently present with acquired conditions that overlap with adult general surgical practice. We aimed to quantify the adolescent contribution to a tertiary Caribbean paediatric surgical service and describe how congenital/developmental and acquired disease varied across age strata. This prospective 12-month service evaluation included referral/admission-log episodes, operative episodes and new outpatient visits managed by the Department of Paediatric Surgery at the Eric Williams Medical Sciences Complex, Trinidad and Tobago, from April 2024 to March 2025. Patients were grouped as neonates, infants, toddlers/preschool children, school-age children and adolescents (12 to <16 years). Diagnoses were classified as congenital/developmental, acquired or mixed using a prespecified ICD-10-informed framework. The primary outcome was the adolescent share of operative activity. The primary cohort comprised 964 referral/admission-log episodes, 379 operative episodes and 661 new outpatient visits. Adolescents accounted for 23.7% of referral/admission-log episodes, 17.4% of operations and 11.5% of new visits. They contributed 25.7% of emergency referrals and 28.7% of emergency operations. Acquired disease accounted for 72.7% of adolescent operations, compared with 13.3% in neonates, while congenital/developmental disease fell from 80.0% to 24.2%. Scrotal exploration, appendicectomy and drainage of soft-tissue collections comprised 97.0% of adolescent emergency operations. Adolescents generated a substantial, acquired-disease-dominant emergency workload. The findings support review of diagnosis-specific shared-care pathways while preserving paediatric resources for neonatal, congenital, oncological and reconstructive surgery.
