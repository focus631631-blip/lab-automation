...
- 国家/单位: 日本 · Kanagawa Children's Medical Center
- 通讯作者: Masutani S (masutani@saitama-med.ac.jp)
- DOI: 10.1038/s41390-026-05339-z
- 获取全文: [DOI 全文](https://doi.org/10.1038/s41390-026-05339-z) · [PubMed](https://pubmed.ncbi.nlm.nih.gov/42552416/)

**中文总结**：- 研究目的：比较新生儿出生后早期血清NT-proBNP水平与超声心动图PLASE评分对动脉导管未闭（PDA）手术需求的预测能力。
- 核心发现/数据：共纳入126例23-29周早产儿，23例（18%）接受了PDA手术；3日龄NT-proBNP联合胎龄的预测模型ROC-AUC为0.826，与PLASE评分（0.829）相当（p=0.94），且显著优于单独NT-proBNP模型（0.669，p=0.02）。
- 临床启示：早期NT-proBNP联合胎龄可有效预测未来PDA手术风险，有望作为超声心动图的补充工具，用于PDA管理的风险评估。

**原文摘要**：Although serum NT-proBNP is a useful marker of patent ductus arteriosus (PDA) severity in the early postnatal period, its ability to predict the future need for PDA surgery remains unclear. This study aimed to compare the predictive abilities of early NT-proBNP and the PLASE score using an established echocardiographic model. Infants born at 23-29 weeks of gestation between 2019 and 2024 and admitted to a tertiary neonatal intensive care unit were included. Serum NT-proBNP levels and echocardiographic indices at 3 days of age were retrospectively collected. Three predictive models were evaluated: Model 1, the PLASE score (reference); Model 2, log Among 126 infants included, 23 (18%) underwent PDA surgery. The ROC-AUCs (95% CI) were 0.829 (0.748-0.910) for Model 1, 0.669 (0.539-0.798) for Model 2, and 0.826 (0.741-0.911) for Model 3. Model 1 yielded higher ROC-AUC than Model 2 (p = 0.02), whereas no significant difference was observed between Model 1 and Model 3 (p = 0.94). Early postnatal NT-proBNP combined with gestational age showed high predictive ability comparable to the PLASE score. NT-proBNP could be used to estimate the likelihood of future PDA surgery. N-terminal pro-B-type natriuretic peptide (NT-proBNP) measured at 3 days of age, when combined with gestational age, demonstrated high predictive ability for patent ductus arteriosus (PDA) surgery (Area under the receiver operating characteristic curve: 0.826). Early postnatal NT-proBNP yielded results equivalent to those of the PLASE score, an echocardiographic prediction model. This study suggests that early NT-proBNP assessment may complement echocardiographic evaluation in the management of PDA.
